...
| 10  | Opt-in embedders               | `FOAM_EMBEDDER=ollama\|openai\|bedrock` with provider env vars; graceful fallback to default with warning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- [ ] `src/semantic/embedder/ollama.ts` (probe + fallback)
- [ ] `src/semantic/embedder/openai.ts`
- [ ] `src/semantic/embedder/bedrock.ts`
